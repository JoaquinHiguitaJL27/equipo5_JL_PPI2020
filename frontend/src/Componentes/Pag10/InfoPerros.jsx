...
import BP from '../Paginas/img/InfoPe.jpg';
...
function InfoPerros() {
    ...
    PetSociety</a>
            ...
            <h2 className="text-center">¿Cómo bañar a un cachorro por primera vez?</h2>
...
<h2>HA LLEGADO EL MOMENTO DEL BAÑO</h2>
...
<h2>FACTORES QUE DETERMINAN CÓMO BAÑAR A UN PERRO </h2>
...
<h2>CON CUÁNTA FRECUENCIA DEBES BAÑAR A TU PERRO</h2>
...
Problemas de piel. Si tu perro tiene tendencia a alguna enfermedad dermatológica, es probable que tu veterinario establezca la frecuencia idónea para su baño, así como los productos que puedes usar. Si tienes cualquier duda, consúltala. </p>
...
A la hora de secar, debes hacerlo primero con una toalla. Una vez que se elimina el exceso de humedad, cepilla el pelo de tu perro. Si tiene el pelo largo, desenrédalo y deshaz los nudos que encuentres. Es muy importante secar bien las áreas sensibles a desarrollar dermatitis, las que tienen alta densidad de pelo o en las que se forman pliegues (especialmente en razas como Shar Pei, Pequinés o Bulldog Inglés).
...
Si resultara del todo imposible utilizar el secador, puedes crear un ambiente cálido en la habitación con radiadores u otra fuente de calor que ayuden a secar a tu perro por completo. En este caso, ten mucho cuidado, evita quemaduras y otras situaciones perjudiciales para tu perro.</p>
